            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div class="text-center max-w-3xl mx-auto animate-slide-up">
                    <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-medium mb-6 animate-pulse-slow">
                       ...
                       Proper website releasing in January
                    </div>
    ...
    <script>
        ...
        const ENRICHED_DATA = {
            'SillyTavern-CostumeSwitch': {
                ...
                installCommand: "/extensions install https://github.com/Archkr/SillyTavern-CostumeSwitch",
            ...
            'SillyTavern-OutfitSwitch': {
                ...
                installCommand: "/extensions install https://github.com/Archkr/SillyTavern-OutfitSwitch",
            ...
            'ST-WorldEngine': {
                ...
                installCommand: "/extensions install https://github.com/Archkr/ST-WorldEngine",
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="glass p-6 rounded-2xl border-t-4 ${isLorebook ? 'border-secondary' : 'border-primary'}">
                            ...
                            ${!isLorebook ? `
                            <div class="relative">
                                <div class="text-xs text-slate-500 mb-2 uppercase font-bold tracking-wider">Install Command</div>
